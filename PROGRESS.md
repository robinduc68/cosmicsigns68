...
| Phase 6 — An sao | 🟡 **51 sao** + Tứ Hóa; miếu vượng đã nối nhưng **bảng còn rỗng** |
...
Quality gate **đều xanh**: **732 test pass** (519 engine + 41 api + 172 web),
...
- **Ngũ hành của sao: 23/51** (known 23 · disputed 4 · not recorded 24). Nhóm 2 để trống toàn bộ (`NOT_RECORDED` — chưa tra được,

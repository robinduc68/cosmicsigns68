...
| Số tháng ở footer | 🔴 engine không cấp `month_number`; luật suy ra nó là một quy ước chưa chốt — không đoán |
...
- **Phụ tinh nhóm 2 (`stars/placement_group2.py`)**: Long Trì, Phượng Các, Tam Thai,
  ...
  Thiếu Âm, Hoa Cái, Thiên Tài, Thiên Thọ, Thiên Quan, Thiên Phúc, Thiên Giải, Địa Giải,
  Thai Phụ, Phong Cáo, Quốc Ấn, Đường Phù, Hỷ Thần — **24 sao**. Sao nào phụ thuộc vị trí
  thì **đọc lại sao neo từ lá số**, không tính lại.
- **Sát tinh nhóm 1 (`stars/placement_malefic.py`)**: Địa Không, Địa Kiếp, Hỏa Tinh,
...
- **Năm xem từng mặc định là "không xem lưu niên"**, nên cả lớp lưu niên vô hình cho

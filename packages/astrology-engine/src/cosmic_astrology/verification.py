...
_RULE_LABELS: dict[RuleId, str] = {
    ...
    RuleId.CHU_MENH_CHU_THAN: "Chủ Mệnh / Chủ Thân",
    RuleId.LUU_HA: "Lưu Hà",
    RuleId.THIEN_TRU: "Thiên Trù",
    RuleId.THIEN_Y: "Thiên Y",
    RuleId.GIAI_THAN: "Giải Thần",
    ...
    RuleId.THIEN_QUAN_THIEN_PHUC: "Thiên Quan / Thiên Phúc",
    RuleId.THIEN_GIAI_DIA_GIAI: "Thiên Giải / Địa Giải",
    RuleId.THAI_PHU_PHONG_CAO: "Thai Phụ / Phong Cáo",
    RuleId.QUOC_AN_DUONG_PHU: "Quốc Ấn / Đường Phù",
    RuleId.BAC_SI_CYCLE: "Vòng Bác Sĩ (Hỷ Thần)",
    RuleId.DIA_KHONG_DIA_KIEP: "Địa Không / Địa Kiếp",
    RuleId.HOA_TINH_LINH_TINH: "Hỏa Tinh / Linh Tinh",
    RuleId.KIEP_SAT: "Kiếp Sát",
    RuleId.CO_THAN_QUA_TU: "Cô Thần / Quả Tú",
    RuleId.THIEN_KHONG: "Thiên Không",
    RuleId.THIEN_KHOC_THIEN_HU: "Thiên Khốc / Thiên Hư",
    RuleId.PHA_TOAI: "Phá Toái",
    RuleId.THIEN_HINH_THIEN_DIEU: "Thiên Hình / Thiên Diêu",

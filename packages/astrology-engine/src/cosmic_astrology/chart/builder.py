...
#
# 0.4.6: mỗi sao mang thêm ``traditional_column`` — cột trái/phải của bản in. Siêu dữ
# liệu TRÌNH BÀY: không phép an sao nào đọc nó, và nó không liên quan tới màu.
ENGINE_VERSION = "0.4.6-frame"
